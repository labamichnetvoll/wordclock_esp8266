...
//own design
  const String clockStringGerman =  "ESPISTKFUNFZEHNZWANZIGVIERTELGVORDNACHAHALBJVIEREINSFMODIYZWOLFUNFACHTZWEIKMIDOXDREINEUNSECHSELFIFRSAVOSIEBENEZEHNIUHRYSO";
